...
if(isset($_POST['submit'])){
    ...
    $select_student = mysqli_query($connect,"SELECT * FROM user WHERE email = '$email' AND password = '$password'");
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form method="POST" action="">
                                ...
                                <div>
                                    <button class="btn btn-dark btn-block border-0 py-3" name="submit" type="submit">Login</button>
                                </div>
                                
                                
                               
                             
                                <p class="text-light mt-2">Dont Have an Account?</p>
                                <div>
                                    <a href="register.php" class="btn btn-dark btn-block border-0 py-2 mt-2">Sign Up Now</a>
