...
if(isset($_GET['cat'])){
    ...
    $category = $_GET['cat'];
    $select_subject = mysqli_query($connect,"SELECT * FROM subject WHERE category = '$category'");
}else{
$select_subject = mysqli_query($connect,"SELECT * FROM subject");
}
?>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="subject.php" class="nav-item nav-link active">Subjects</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Subjects</h3>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Package</h5>
                <h1>Our Subjects Fees</h1>
            </div>
            <div class="mb-4">
            <a href="subject.php?cat=UPSR" class="btn btn-primary">UPSR</a>
            <a href="subject.php?cat=PT3" class="btn btn-warning">PT3</a>
            <a href="subject.php?cat=SPM" class="btn btn-danger">SPM</a>
            </div>
                    ...
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-users text-primary mr-2"></i>10 Students</small>
                                <small class="m-0"><i class="far fa-clock text-primary mr-2"></i><?= $row['time'] ?> hours</small>
                            </div>
                            <a class="h5" href="schedules.php?id_subject=<?= $row['subject_id'] ?>"><?= $row['name'] ?></a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0">RM<?= $row['price'] ?></h5>
                                </div>
                            </div>
                            <a href="update_cart.php?subject_id=<?= $row['subject_id'] ?>" class=" mt-3 btn btn-dark text-light">Add To Schedule</a>
                        </div>
                    </div>
                </div>
                <?php }?>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">Bahasa Malaysia</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">History</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">Chemistry</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">Biology</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-white font-weight-medium">Account</h4>
